...
// Read-only counterpart to Schedule.jsx's grouping/search — kept as a
// straight copy of that logic rather than a shared import so the live
// (currently unrouted) attendee version can be restored next year without
// this page's stripped-down behavior tagging along.
const GROUP_MODES = [
  { key: 'time', label: 'Time' },
  { key: 'room', label: 'Room' },
...
export default function PublicSchedule() {
  ...
  return (
    <div className="flex flex-col gap-4 px-4 pt-6 pb-6">
      <div>
        <h1 className="text-2xl font-semibold">History Camp 2026 Schedule</h1>
        <p className="mt-1 text-sm text-ink/60">A look back at the day's sessions.</p>
      </div>
